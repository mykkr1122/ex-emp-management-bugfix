...
$(function(){
    ...
    $("#searchName").on("input", function() {
        ...
        let filteredList = autocompleteList.filter(function(option) {
    ...
    function showAutocomplete(options) {
        ...
        if (options.length > 0) {
            let autocompleteDropdown = $("<ul>").attr("id", "autocompleteDropdown");

            options.forEach(function(option) {
                let listItem = $("<li>").text(option);
                listItem.on("click", function() {
                    $("#searchName").val(option);
                    hideAutocomplete();
                });
                autocompleteDropdown.append(listItem);
            });

            $("#searchName").parent().append(autocompleteDropdown);
        }
    }
